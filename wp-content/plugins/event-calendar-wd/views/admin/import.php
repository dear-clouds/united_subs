        ...
        <div id="ecwd-settings-content">
            ...
            <form method="post" action="" enctype="multipart/form-data">
                ...
                <div id="ecwd-form-import" style='margin-top:10px;' class="ecwd-form-import">
                    <select name="ecwd__import">
                        <option value="events"><?php _e('Events', 'ecwd')?></option>
                        <option value="organizers"><?php _e('Organizers', 'ecwd')?></option>
                        <option value="venues"><?php _e('Venues', 'ecwd')?></option>
                    </select></br>
                    <input type="hidden" name="MAX_FILE_SIZE" value="30000"/>
                    <input type='file' name='ecwd_calendar_events_xml_file' class=''/>
					<div class="ecwd-calendar-event-import"><?php _e('Choose csv file', 'ecwd'); ?></div>
                </div>
                <?php submit_button(__('Import', 'ecwd') ); ?>
            </form>
            <!-- export -->
            <form method="post" action="">
                <div id="ecwd-form-export" style='margin-top:10px;' class="ecwd-form-export">
                    ...
                    <?php submit_button( __('Download Export File', 'ecwd') )?>
                </div>
            </form>
        </div>
