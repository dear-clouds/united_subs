					...
					<tr id="m-<?php bp_message_thread_id(); ?>" class="<?php bp_message_css_class(); ?><?php if ( bp_message_thread_has_unread() ) : ?> unread<?php else: ?> read<?php endif; ?>">
						...
						<td class="thread-options">
							<?php if ( bp_message_thread_has_unread() ) : ?>
								<a class="read only-icon btn btn-default" href="<?php bp_the_message_thread_mark_read_url();?>" title="<?php _e("Read","woffice"); ?>">
									<i class="fa fa-eye"></i>
								</a>
							<?php else : ?>
								<a class="unread only-icon btn btn-default" href="<?php bp_the_message_thread_mark_unread_url();?>" title="<?php _e("Unread","woffice"); ?>">
									<i class="fa fa-eye-slash"></i>
								</a>
							<?php endif; ?>
							<a class="delete only-icon btn btn-default" href="<?php bp_message_thread_delete_link(); ?>" title="<?php _e("Delete","woffice"); ?>">
