...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
    ...
    class TGM_Plugin_Activation {
         ...
         * @var string
         */
        public $menu = 'install-required-plugins';// 'tgmpa-install-plugins';
    ...
    class TGMPA_List_Table extends WP_List_Table {
        ...
        protected function _gather_plugin_data() {
            ...
            foreach ( TGM_Plugin_Activation::$instance->plugins as $plugin ) {
                ...
                //if ( ! isset( $installed_plugins[$plugin['file_path']] ) ) {
                if ( ! in_array($plugin['file_path'], $plugin_dirs) ) {
        ...
        public function column_plugin( $item ) {
            ...
            if(strstr($item['file_path'], '/') === false) {
                $keys = array_keys($installed_plugins);
                $plugin_dirs = array();
                foreach($keys as $key) {
                    $tmp = explode('/', $key);
                ...
                $is_install = ( ! in_array($item['file_path'], $plugin_dirs) )? false : true;
            } else
                $is_install = ( ! isset( $installed_plugins[$item['file_path']] ) )? false : true;
