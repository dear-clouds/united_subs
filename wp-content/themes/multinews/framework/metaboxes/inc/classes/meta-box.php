...
if ( ! class_exists( 'RW_Meta_Box' ) )
{
	...
	class RW_Meta_Box
	{
		...
		function admin_enqueue_scripts()
		{
			...
			wp_enqueue_style( 'momizat-metaboxes', RWMB_CSS_URL . 'momizat.css', array(), RWMB_VER );
			wp_enqueue_script( 'momizat-metaboxes', RWMB_JS_URL . 'momizat.js', array( 'jquery' ), RWMB_VER, true );
