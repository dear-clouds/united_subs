    ...
    <?php $bbp_forums_noheader = ''; while ( bbp_forums() ) : bbp_the_forum();
                            ...
                            <ul id="forums-list-<?php bbp_forum_id(); ?>" class="bbp-forums">
                                    ...
                                    <li class="bbp-header">
                                            ...
                                            <ul class="forum-titles">
                                                    ...
                                                    <li class="bbp-forum-topic-count"><?php _e( 'Topics', 'bbpress' ); ?>/<?php bbp_show_lead_topic() ? _e( 'Replies', 'bbpress' ) : _e( 'Posts', 'bbpress' ); ?></li>
