<tr>
	...
	<div class="post-author"><?php do_action( 'bbp_theme_before_reply_author_details' ); ?>
		...
		<?php _e( 'Topics', 'Xphoria' ); ?>: <?php echo  bbp_get_user_topic_count_raw(bbp_get_reply_author_id()); ?>
		<?php _e( 'Replies', 'Xphoria' ); ?>: <?php echo bbp_get_user_reply_count_raw(bbp_get_reply_author_id()); ?>
		</div>
